...
## Current focus
- capture the first two redesign blockers found on the received hardware
- clean up the repo and keep only the control-board / HAT-board material needed for this effort
- identify the authoritative KiCad files for the next revision

## Known issues to document next
- Issue 1: **TBD from bench / received board review**
- Issue 2: **TBD from bench / received board review**

## Parking lot
- confirm whether the HAT board is active or legacy-only in the next architecture
