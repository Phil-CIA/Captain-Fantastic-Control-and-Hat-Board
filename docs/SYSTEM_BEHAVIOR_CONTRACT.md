...
This top-level copy mirrors the firmware-level contract at:
- firmware/control-board/docs/SYSTEM_BEHAVIOR_CONTRACT.md

Use this document to lock architecture and behavior decisions before implementation.
