...
constexpr uint8_t CAPTAIN_PROTOCOL_MODEL_I2C_REGMAP = 1;
constexpr uint8_t CAPTAIN_PROTOCOL_VERSION_MAJOR = 1;
constexpr uint8_t CAPTAIN_PROTOCOL_VERSION_MINOR = 0;
constexpr uint8_t CAPTAIN_PROTOCOL_VERSION_PATCH = 0;
